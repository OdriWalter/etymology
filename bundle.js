...
(() => {
  ...
  var Renderer = class {
    ...
    _computeViewBounds() {
      ...
      const zoom = typeof this.camera.getNormalizedZoom === "function" ? this.camera.getNormalizedZoom() : Math.log2(Math.max(scale / (this.camera.baseScale > 0 ? this.camera.baseScale : 1), 1e-6));
      return {
        left,
        top,
        width,
